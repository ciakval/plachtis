"""
Django settings for PlachtIS project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-dev-key-for-local-only')
...
MIDDLEWARE = [
    ...
    'PlachtIS.middleware.StaticFilesExpiresMiddleware',
...
WSGI_APPLICATION = 'PlachtIS.wsgi.application'
...
# Uses STORAGES (the Django 4.2+ replacement for the deprecated
# STATICFILES_STORAGE setting) so the configuration is actually applied
# in Django 6.0+.
STORAGES = {
    "default": {
